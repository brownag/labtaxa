...
The goal of {labtaxa} is to support automatic download of 'Lab Data Mart' (<https://ncsslabdatamart.sc.egov.usda.gov/>) database snapshots for use in R.

This repository is an R package used for reproducibly obtaining and caching the contents of the Lab Data Mart Database. 
